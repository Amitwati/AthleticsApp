...
public class Record {
    ...
    public Record(Context context, String title, String record,Boolean enable, String COLOR) {
        if(inflater == null)
        ...
        EditText val = record_view.findViewById(R.id.value_rec);
        ...
        switch (COLOR) {
            case "YELLOW":
                ...
                val.setTextColor(ContextCompat.getColorStateList(context, R.color.colorBright_YELLOW));
            ...
            case "BLUE":
                ...
                val.setTextColor(ContextCompat.getColorStateList(context, R.color.colorBright_BLUE));
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            case "RED":
                ...
                val.setTextColor(ContextCompat.getColorStateList(context, R.color.colorBright_RED));
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            case "GREEN":
                ...
                val.setTextColor(ContextCompat.getColorStateList(context, R.color.colorBright_GREEN));
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
